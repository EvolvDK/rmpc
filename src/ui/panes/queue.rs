...
use crate::{
    ...
    shared::{
        ...
        mpd_query::GLOBAL_STATUS_UPDATE,
    },
    ui::{
        UiAppEvent,
        UiEvent,
            ...
            .list_section(ctx, |mut section| {
                section.add_item("Add queue to playlist", |ctx| {
                    ...
                    if playlists.is_empty() {
                        status_info!("No rmpc playlists exist. Create one first.");
                        return Ok(());
                    }
                    ...
                    modal!(
                        ...
                        SelectModal::builder()
                            ...
                            .options(playlists)
                            .confirm_label("Add")
                            .title("Select an rmpc playlist")
                            .on_confirm(move |ctx, selected_playlist, _idx| {
