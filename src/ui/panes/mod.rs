...
pub enum Panes<'pane_ref, 'pane> {
    ...
    RmpcPlaylists(&'pane_ref mut RmpcPlaylistsPane),
...
pub struct PaneContainer<'panes> {
    ...
    pub rmpc_playlists: RmpcPlaylistsPane,
...
impl<'panes> PaneContainer<'panes> {
    pub fn new(ctx: &Ctx) -> Result<Self> {
        Ok(Self {
            ...
            rmpc_playlists: RmpcPlaylistsPane::new(ctx)?,
    ...
    pub fn get_mut<'pane_ref, 'pane_type_ref: 'pane_ref>(
        ...
        match pane {
            ...
            PaneType::RmpcPlaylists => Ok(Panes::RmpcPlaylists(&mut self.rmpc_playlists)),
...
macro_rules! pane_call {
    ($screen:ident, $fn:ident($($param:expr),+)) => {
        match &mut $screen {
            ...
            Panes::RmpcPlaylists(s) => s.$fn($($param),+),
