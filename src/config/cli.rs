...
#[clap(rename_all = "lower")]
pub enum Command {
    /// Import your YouTube Music library from a Google Takeout CSV file.
    ImportLibrary {
        /// Path to the CSV file (e.g., music-library-songs.csv)
        #[arg(value_hint = ValueHint::FilePath)]
        path: PathBuf,
    },
    /// Import your YouTube Music playlists from a Google Takeout folder.
    ImportPlaylists {
        /// Path to the folder containing playlist CSV files.
